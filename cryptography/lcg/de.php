...
<div class="content m-4">
    <div class="container">
        ...
        <div class="row" style="margin-top:20px;">
            ...
            <div class="col-lg-6">
                <label class="form-label">Enter cipher text here</label>
                <textarea class="form-control" onkeyup="encrypt();" id="cipher_text" rows="3"></textarea>
            </div>

            <div class="col-lg-6">
                <label class="form-label">Display plain text</label>
                <textarea class="form-control" id="plain_text" rows="3"></textarea>
            </div>
...
function encrypt(){
    ...
    var cipher_text = _('cipher_text').value;
    ...
    if(a_value.length>0 && b_value.length>0 && x_value.length>0){
        formdata.append("cipher_text", cipher_text);
...
function completeCrypt(event){
    ...
    var plain_text = res[0].plain_text;
    _('plain_text').value = plain_text;
